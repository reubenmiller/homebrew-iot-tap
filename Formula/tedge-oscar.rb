...
class TedgeOscar < Formula
  desc "Experiment/research in using OCI artifacts for managing some thin-edge.io artifacts"
  homepage "https://github.com/reubenmiller/tedge-oscar"
  url "https://github.com/reubenmiller/tedge-oscar/archive/v0.0.1.tar.gz"
